...
def main():
    ...
    """
    one_card_both = get_one_card_detail("http://dm.takaratomy.co.jp/card/detail/?id=dmrp05-m01")
...
def get_one_card_detail(url):
    ...
    for one_table in table:
        ...
        abilitytxt = one_table.find("td", class_="abilitytxt")
        ability_list = []
...
def write_sqlite(contents, file_name):
    con = sqlite3.connect('./DM_DATE_NEW.db')  # データベースに接続する
